...
<html>
    <head>
        ...
        <meta property="og:title" content="Newdale network - Error 404 🚧">
    ...
    ?>
        <div class="uk-section">
            <div class="uk-container">
                <h1>Error 404 🚧</h1>
                <h3>Requested page was not found or deleted...</h3>
                <a href="/">
                    <button class="uk-button uk-button-default uk-text-capitalize" style="border-radius: 15px;color: white;">Home page</button>
                </a>
            </div>
            <?php
