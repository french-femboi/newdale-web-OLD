...
<html>
    <head>
        ...
        <meta property="og:title" content="Newdale network - Providers ⌨️">
    ...
    ?>
        ...
        <div class="uk-container uk-container-medium" >
            <h2 class="uk-h1 uk-text-center" uk-scrollspy="cls: uk-animation-slide-bottom;">Our providers:</h2>
            <p class="uk-text-lead uk-text-center" uk-scrollspy="cls: uk-animation-slide-bottom;">We cannot show you the information of our private host!</p>
            <div class="uk-child-width-1-2@m uk-grid-match uk-text-center uk-margin-medium-top uk-grid" data-uk-grid="" style="margin: 20px;">
                <div>
                    <div class="uk-card uk-card-default uk-box-shadow-medium uk-card-hover uk-card-body uk-inline" uk-scrollspy="cls: uk-animation-slide-bottom;" style="border-radius: 15px;">
                        ...
                        <h3 class="uk-card-title uk-margin uk-text-success">IONOS 1&1</h3>
                        <p>Websites, e-mails, file servers</p>
                    </div>
                </div>
                <div>
                    <div class="uk-card uk-card-default uk-box-shadow-medium uk-card-hover uk-card-body uk-inline" uk-scrollspy="cls: uk-animation-slide-bottom;" style="border-radius: 15px;">
                        <a class="uk-position-cover"></a>
                        <h3 class="uk-card-title uk-margin uk-text-success">OVH Saas</h3>
                        <p>DDOS-protection</p>
                    </div>
                </div>
                <div>
                    <div class="uk-card uk-card-default uk-box-shadow-medium uk-card-hover uk-card-body uk-inline" uk-scrollspy="cls: uk-animation-slide-bottom;" style="border-radius: 15px;">
                        <a class="uk-position-cover"></a>
                        <h3 class="uk-card-title uk-margin uk-text-success">Private host</h3>
                        <p>Other services</p>
                    </div>
                </div>
            </div>
